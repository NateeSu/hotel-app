-- Simple T009: Room Transfer System Database Schema
-- เฉพาะตารางที่จำเป็นสำหรับระบบย้ายห้อง
...
-- Create view for transfer summary (without customers dependency)
-- สร้าง view สำหรับสรุปการย้ายห้อง
...
-- Create view for daily transfer stats
...
SELECT 'Room transfer tables created successfully!' as status;
